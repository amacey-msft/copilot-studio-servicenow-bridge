...
| **URL slug** | `pbqgkr6d` | Only appears inside the public hostname `https://<slug>-<port>.<region>.devtunnels.ms`. This is what goes in the bridge `BRIDGE_PUBLIC_URL` for local dev. |
